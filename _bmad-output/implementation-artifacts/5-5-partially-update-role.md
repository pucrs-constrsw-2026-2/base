...
- [ ] Task 1 — `PATCH /roles/:id` (AC: #1)
  - [ ] Merge subset onto existing client role; README lists allowed fields
  - [ ] This is **not** user password PATCH and **not** role logical-delete
- [ ] Task 2 — Errors + Bearer
- [ ] Task 3 — Tests
...
**In scope:** partial update of client role.
...
**Out of scope:** 5.6 DELETE, 5.7 assign.
...
- [Source: `epics.md` — Story 5.5, FR11, FR13]
- [Source: Story 5.4 allowed attributes / README]

## Previous story intelligence

Reuse 5.3 get + 5.4 PUT-to-Keycloak after merge.

## Latest tech information

- Keycloak has no JSON Patch for roles; implement merge in oauth then PUT Admin.
